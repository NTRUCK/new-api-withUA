...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"aff_code_required":         common.AffCodeRequiredForRegister,
		// 邀请专属 DC 准入开启后，注册仅可通过 Discord 完成
		"aff_discord_gating":     len(system_setting.GetDiscordSettings().GetAffGuildRules()) > 0,
