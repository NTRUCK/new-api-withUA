	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/active_users", controller.GetActiveUsers)
				...
				selfRoute.POST("/dice_game/welfare", middleware.CriticalRateLimit(), controller.ClaimDiceWelfare)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/inactive", controller.GetInactiveUsers)
				adminRoute.GET("/status_counts", controller.GetUserStatusCounts)
				...
				adminRoute.POST("/batch_adjust_quota_by_balance", middleware.CriticalRateLimit(), controller.BatchAdjustUserQuotaByBalance)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/models_with_channels", controller.ModelsWithChannels)
			...
			channelRoute.POST("/:id/convert_multi_key", middleware.RootAuth(), middleware.CriticalRateLimit(), controller.ConvertChannelToMultiKey)
		...
		logRoute.GET("/activity_stats", middleware.AdminAuth(), controller.GetUserActivityStats)
		logRoute.GET("/users", middleware.AdminAuth(), controller.GetLogUsers)
